...
export default function Maintenance() {
  const [portfolioMetrics, setPortfolioMetrics] = useState(() => createEmptyMetrics());
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!active) return;
        setPortfolioMetrics(snapshot.metrics);
  ...
  return (
    <section className="space-y-8">
      ...
      <DashboardBridge metrics={portfolioMetrics} focus="Maintenance" />
