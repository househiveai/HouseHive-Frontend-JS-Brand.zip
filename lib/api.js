...
// Auth
export const apiRegister = (payload) => j('POST', '/api/auth/register', payload);
export const apiLogin = (email, password) => j('POST', '/api/auth/login', { email, password });
export const apiMe = () => j('GET', '/api/auth/me');
