...
export default function Maintenance() {
  const [metricsState, setMetricsState] = useState(() => createEmptyMetrics());
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!active) return;
        setMetricsState(snapshot.metrics ?? createEmptyMetrics());
        ...
        if (!active) return;
        setMetricsState((current) => current ?? createEmptyMetrics());
  ...
  const metrics = metricsState ?? createEmptyMetrics();
